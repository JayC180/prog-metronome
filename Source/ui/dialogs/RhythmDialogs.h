...
class DialogPanel : public juce::Component {
  public:
    ...
    void addAction(juce::String label, juce::Colour bg, juce::Colour border,
                   juce::Colour text, std::function<void()> cb);
...
class MmDialog : public DialogPanel {
  public:
    MmDialog(std::optional<int> initialP, std::optional<int> initialQ,
...
class SetBpmDialog : public DialogPanel {
  public:
    SetBpmDialog(double currentBpm, std::optional<double> initialBpm,
...
class CustomNumberDialog : public DialogPanel {
  public:
    CustomNumberDialog(juce::String title, juce::String hint,
...
class ListPickerDialog : public DialogPanel {
  public:
    ...
    ListPickerDialog(juce::String title, std::vector<Entry> entries,
