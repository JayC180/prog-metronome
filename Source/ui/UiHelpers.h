...
class ChipButton : public juce::Component, public juce::SettableTooltipClient {
  public:
    ...
    void setStateColor(StateColor s) {
        state_ = s;
        repaint();
    }
    ...
    void setFontSize(float pts) {
        fontSize_ = pts;
        repaint();
    }
    void setEnabledLook(bool b) {
        enabledLook_ = b;
        setInterceptsMouseClicks(b, b);
        repaint();
    }
  ...
  private:
    ...
    void resolveColours(juce::Colour &bg, juce::Colour &border,
