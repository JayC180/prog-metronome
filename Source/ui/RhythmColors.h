...
class RhythmColors {
  public:
    ...
    static juce::Colour accentBorder() {
        return active().accent.withAlpha(0.45f);
    }
    static juce::Colour cautionBg() {
        return active().caution.withAlpha(0.15f);
    }
    static juce::Colour cautionBorder() {
        return active().caution.withAlpha(0.45f);
    }
    static juce::Colour dangerBg() { return active().danger.withAlpha(0.18f); }
    static juce::Colour dangerBorder() {
        return active().danger.withAlpha(0.45f);
    }
    static juce::Colour infiniteBg() {
        return active().repeatText.withAlpha(0.15f);
    }
    static juce::Colour infiniteBorder() {
        return active().repeatText.withAlpha(0.5f);
    }
    ...
    static juce::Colour setBpmBg() {
        return active().setBpmText.withAlpha(0.10f);
    }
    static juce::Colour beatRestBg() { return active().bg2; }
    static juce::Colour beatPlayingBg() {
        return active().accentBright.withAlpha(0.18f);
    }
    ...
    static juce::Colour beatSelectedBorder() {
        return active().beatSelectedBorder;
    }
